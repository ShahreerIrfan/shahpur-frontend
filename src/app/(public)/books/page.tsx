      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="bg-[#1c120c] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#2a1b11] via-[#170e09] to-[#0f0906] rounded-3xl border border-[#2b1b11] shadow-2xl p-4 md:p-8 relative overflow-hidden">
              {/* Wooden shelves list */}
