  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        const url = `${API_URL}/events/list/?${params.toString()}`;
    ...
    <div className="min-h-screen bg-gray-50/30 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-8 flex flex-col md:flex-row md:items-center gap-3 justify-between">
          ...
          <select value={category} onChange={(e) => handleCategoryChange(e.target.value)} className="w-full md:w-64 px-4 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-primary-500 bg-gray-50">
          ...
          <>
            ...
            {totalPages > 1 && (
              <div className="flex flex-col items-center gap-3 bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-5 mt-8">
                <p className="text-sm text-gray-500">মোট {count}টি ইভেন্ট · পৃষ্ঠা {page} / {totalPages}</p>
